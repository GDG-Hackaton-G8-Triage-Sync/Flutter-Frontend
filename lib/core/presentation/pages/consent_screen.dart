...
class _DataConsentScreenState extends State<DataConsentScreen> {
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const Icon(Icons.security_outlined, color: Color(0xFF005EB8), size: 48),
              ...
              const Text(
                ...
                style: TextStyle(fontSize: 15, color: Color(0xFF44474E), height: 1.5),
              ),
              ...
              Padding(
                ...
                child: SizedBox(
                  ...
                  child: ElevatedButton(
                    onPressed: (_acceptedAI && _acceptedTerms) ? widget.onAccepted : null,
  ...
  Widget _buildConsentTile(String title, String subtitle, bool value, ValueChanged<bool?> onChanged) {
    return InkWell(
      ...
      child: Container(
        padding: const EdgeInsets.all(16),
        decoration: BoxDecoration(
          border: Border.all(color: value ? const Color(0xFF005EB8) : const Color(0xFFDDE4F0)),
          borderRadius: BorderRadius.circular(16),
          color: value ? const Color(0xFF005EB8).withValues(alpha: 0.02) : Colors.transparent,
        ),
        child: Row(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
